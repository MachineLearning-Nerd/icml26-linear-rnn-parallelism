# Claim 2 — Boolean-circuit depth

## Current formal regression

**Verdict: VERIFIED.** Twenty-two sizes from 1 through 65,536 reproduce the
balanced scan depth exactly. The audit separately checks five log-star tower
