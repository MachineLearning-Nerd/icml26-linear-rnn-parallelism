# Claim 4 — Poly-precision nonlinear RNNs

## Current formal regression

**Verdict: VERIFIED.** The checker exhausts all 32,767 binary stacks through
depth 14, performs 200 seeded round trips through depth 200, evaluates all
29,524 strings of length at most 9 over `{a,b,c}`, and checks 1,568 assignments
