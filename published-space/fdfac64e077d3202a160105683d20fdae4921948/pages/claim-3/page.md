# Claim 3 — Sorted deterministic graph connectivity

## Current formal regression

**Verdict: VERIFIED.** The complete domain through six vertices contains
`1 + 8 + 54 + 384 + 3,000 + 25,920 = 29,367` source/target instances. The
reference walk, counter machine, and integer-exact ReLU RNN agree everywhere.
